...
const SEED_CURATED: CuratedProject[] = [
  { id: "sc_1", scope: "scope", title: "Build an AI Study Planner for Students", category: "AI", difficulty: "Advanced", seatsTotal: 8, seatsFilled: 5, timeline: "6 weeks", skills: ["React", "LLM APIs", "Product Design"], description: "Ship a Gen-Z AI assistant that builds personalized study plans, tracks progress and nudges weekly. Selected builders get featured nationally.", rewards: "₹25k stipend · Scope Spotlight · Letter of Recommendation", status: "live", cover: "🧠", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 2 },
  { id: "sc_2", scope: "scope", title: "Launch the Chapter Growth Campaign", category: "Marketing", difficulty: "Intermediate", seatsTotal: 12, seatsFilled: 9, timeline: "4 weeks", skills: ["Content", "Community", "Design"], description: "Drive 10,000 new builder signups across 50 campuses. Real campaign, real metrics, real impact.", rewards: "₹15k stipend · Campus Leader badge · 500 XP", status: "live", cover: "📣", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 4 },
  { id: "sc_3", scope: "scope", title: "Create the National Innovation Magazine", category: "Media", difficulty: "Intermediate", seatsTotal: 10, seatsFilled: 3, timeline: "8 weeks", skills: ["Writing", "Editorial", "Design"], description: "Curate India's first student-led innovation publication. Print + digital, distributed to 100+ campuses.", rewards: "Published byline · ₹10k honorarium · Editorial badge", status: "live", cover: "📰", postedBy: "Scope Official", postedAt: Date.now() - 86400000 },
  { id: "sc_4", scope: "scope", title: "Design Scope Connect Mobile UI Pack", category: "Design", difficulty: "Advanced", seatsTotal: 5, seatsFilled: 4, timeline: "5 weeks", skills: ["Figma", "Mobile UX", "Prototyping"], description: "Lead the visual system for Scope Connect's iOS + Android app. Your work ships to 50,000+ builders.", rewards: "Portfolio feature · ₹20k · Founding Designer credit", status: "closing-soon", cover: "🎨", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 6 },
  { id: "sc_5", scope: "scope", title: "Create Student Resume Analyzer", category: "AI", difficulty: "Intermediate", seatsTotal: 6, seatsFilled: 2, timeline: "5 weeks", skills: ["Python", "NLP", "Next.js"], description: "Build an open-source resume analyzer trained on real anonymized student CVs. Free tool for the entire ecosystem.", rewards: "Open-source credit · ₹15k · 400 XP", status: "live", cover: "📄", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 3 },
  { id: "sc_6", scope: "scope", title: "Build Founder Pitch Deck Templates", category: "Startup", difficulty: "Beginner", seatsTotal: 8, seatsFilled: 6, timeline: "3 weeks", skills: ["Design", "Storytelling"], description: "Ship 12 founder pitch deck templates used by every Scope founder track applicant.", rewards: "Founding Designer credit · 350 XP · ₹8k", status: "live", cover: "📊", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 5 },
  { id: "sc_7", scope: "scope", title: "Research Youth Startup Trends in India", category: "Research", difficulty: "Intermediate", seatsTotal: 15, seatsFilled: 7, timeline: "6 weeks", skills: ["Research", "Survey Design", "Writing"], description: "Co-author the 2026 Indian Student Startup Trends Report. Distributed to investors, accelerators, and 200+ campuses.", rewards: "Published research credit · ₹12k · 500 XP", status: "live", cover: "📈", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 7 },
  { id: "sc_8", scope: "scope", title: "Build Scope Connect Browser Extension", category: "Web/App", difficulty: "Advanced", seatsTotal: 4, seatsFilled: 3, timeline: "5 weeks", skills: ["TypeScript", "Chrome APIs"], description: "Ship a browser extension that surfaces matching opportunities while builders browse the web.", rewards: "₹18k · Founding Engineer credit · 450 XP", status: "closing-soon", cover: "🧩", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 6 },
  { id: "sc_9", scope: "scope", title: "Launch Scope Weekly Newsletter", category: "Media", difficulty: "Beginner", seatsTotal: 6, seatsFilled: 4, timeline: "Ongoing", skills: ["Writing", "Editorial"], description: "Curate the weekly Scope newsletter — 8 essential stories per week. Reach 50k+ builders.", rewards: "Editor credit · ₹6k/month · 250 XP/week", status: "live", cover: "✉️", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 4 },
  { id: "sc_10", scope: "scope", title: "Build Campus Discovery Engine", category: "Web/App", difficulty: "Intermediate", seatsTotal: 5, seatsFilled: 1, timeline: "6 weeks", skills: ["React", "Search", "Data"], description: "Ship the search engine that helps every Indian student find their ideal campus chapter in 30 seconds.", rewards: "₹16k · 400 XP · Founding Engineer credit", status: "live", cover: "🔎", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 2 },
  { id: "sc_11", scope: "scope", title: "Direct India's First Builder Documentary", category: "Media", difficulty: "Advanced", seatsTotal: 4, seatsFilled: 2, timeline: "10 weeks", skills: ["Video", "Storytelling", "Editing"], description: "Document the lives of 5 student founders across 5 cities. Premieres at Scope Demo Day.", rewards: "Director credit · ₹30k · Premiere screening", status: "live", cover: "🎬", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 8 },
  { id: "sc_12", scope: "scope", title: "Design Scope Brand Identity v2", category: "Design", difficulty: "Advanced", seatsTotal: 3, seatsFilled: 1, timeline: "4 weeks", skills: ["Brand", "Typography", "Visual"], description: "Refresh Scope Connect's brand system. Logos, type, color, motion — the whole stack.", rewards: "Founding Brand credit · ₹25k · 500 XP", status: "live", cover: "🎯", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 1 },
  { id: "sc_13", scope: "scope", title: "Launch Scope Builder Podcast", category: "Media", difficulty: "Intermediate", seatsTotal: 3, seatsFilled: 2, timeline: "Ongoing", skills: ["Audio", "Interviewing", "Production"], description: "Host a weekly podcast featuring student founders, designers, and researchers shipping in India.", rewards: "Host credit · ₹8k/episode · 300 XP", status: "live", cover: "🎙", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 5 },
  { id: "sc_14", scope: "scope", title: "Build Scope Mentor Match Platform", category: "Web/App", difficulty: "Advanced", seatsTotal: 5, seatsFilled: 0, timeline: "7 weeks", skills: ["React", "Algorithms", "Product"], description: "Match 5,000+ student builders with industry mentors. Algorithmic, opt-in, weekly office hours.", rewards: "₹22k · Founding Engineer credit · 500 XP", status: "live", cover: "🤝", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 1 },
  { id: "sc_15", scope: "scope", title: "Launch Scope Climate Action Cohort", category: "Community Growth", difficulty: "Intermediate", seatsTotal: 20, seatsFilled: 11, timeline: "8 weeks", skills: ["Community", "Climate", "Operations"], description: "Run India's largest student climate action cohort. 200 builders, 20 campuses, real on-ground projects.", rewards: "Cohort Lead credit · ₹14k · 450 XP", status: "live", cover: "🌍", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 9 },
  { id: "sc_16", scope: "scope", title: "Design the Scope Hack '26 Brand Kit", category: "Design", difficulty: "Intermediate", seatsTotal: 4, seatsFilled: 3, timeline: "3 weeks", skills: ["Brand", "Print", "Motion"], description: "Lead visual identity for India's largest student hackathon. 2,400 participants, 50 cities.", rewards: "Brand credit · ₹15k · 400 XP", status: "closing-soon", cover: "🪩", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 4 },
  { id: "sc_17", scope: "scope", title: "Build Scope Connect API for Recruiters", category: "Web/App", difficulty: "Advanced", seatsTotal: 3, seatsFilled: 1, timeline: "6 weeks", skills: ["Node.js", "API Design"], description: "Ship the recruiter-facing API so companies can discover Scope builders by skill, campus and momentum.", rewards: "₹20k · Founding Engineer credit · 500 XP", status: "live", cover: "🛰", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 2 },
  { id: "sc_18", scope: "scope", title: "Run a National Student Design Sprint", category: "Design", difficulty: "Intermediate", seatsTotal: 50, seatsFilled: 28, timeline: "1 weekend", skills: ["Design", "Prototyping"], description: "48-hour design sprint solving a real public-sector brief. Top 5 entries get fellowships.", rewards: "Design Fellow credit · ₹10k team prize · 350 XP", status: "live", cover: "✏️", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 3 },
  { id: "sc_19", scope: "scope", title: "Build Scope Onboarding Game", category: "Web/App", difficulty: "Intermediate", seatsTotal: 4, seatsFilled: 2, timeline: "4 weeks", skills: ["React", "Game Design"], description: "Turn first-time onboarding into a 60-second game. Test it on 1,000+ new builders.", rewards: "₹14k · 400 XP · Founding Designer credit", status: "live", cover: "🕹", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 6 },
  { id: "sc_20", scope: "scope", title: "Compose the Scope Anthem", category: "Media", difficulty: "Beginner", seatsTotal: 2, seatsFilled: 0, timeline: "3 weeks", skills: ["Music", "Production"], description: "Write and produce the official anthem for Scope Hack '26. Premieres at the opening keynote.", rewards: "Composer credit · ₹12k · Premiere feature", status: "live", cover: "🎵", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 1 },
  { id: "sc_21", scope: "scope", title: "Build Scope Builder Wallet (XP redemption)", category: "Web/App", difficulty: "Advanced", seatsTotal: 4, seatsFilled: 1, timeline: "7 weeks", skills: ["React", "Payments"], description: "Ship the XP redemption layer — convert XP into perks, courses, and partner credits.", rewards: "₹20k · 500 XP · Founding Engineer credit", status: "live", cover: "👛", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 5 },
  { id: "sc_22", scope: "scope", title: "Lead the Scope Ambassador Program", category: "Community Growth", difficulty: "Intermediate", seatsTotal: 25, seatsFilled: 14, timeline: "12 weeks", skills: ["Community", "Leadership"], description: "Onboard, train, and support 500+ campus ambassadors across India.", rewards: "Ambassador Lead credit · ₹16k · 500 XP", status: "live", cover: "🌟", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 6 },
  { id: "sc_23", scope: "scope", title: "Build Scope Connect Notion OS", category: "Startup", difficulty: "Beginner", seatsTotal: 5, seatsFilled: 2, timeline: "3 weeks", skills: ["Notion", "Templates"], description: "Ship the Notion OS that every campus chapter can clone for ops, planning and growth.", rewards: "Founding Templates credit · ₹6k · 250 XP", status: "live", cover: "🗂", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 2 },
  { id: "sc_24", scope: "scope", title: "Translate Scope into 6 Indian Languages", category: "Community Growth", difficulty: "Intermediate", seatsTotal: 12, seatsFilled: 4, timeline: "5 weeks", skills: ["Translation", "Localization"], description: "Make Scope Connect accessible in Bengali, Hindi, Tamil, Telugu, Marathi, Kannada.", rewards: "Localization credit · ₹3k/language · 300 XP", status: "live", cover: "🌐", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 4 },
  { id: "sc_25", scope: "scope", title: "Direct the Scope Demo Day Showcase", category: "Media", difficulty: "Advanced", seatsTotal: 3, seatsFilled: 1, timeline: "6 weeks", skills: ["Production", "Stage Design", "Direction"], description: "Direct the live showcase where 25 student founders pitch to a national audience.", rewards: "Director credit · ₹25k · Stage feature", status: "live", cover: "🎭", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 7 },
];
...
const SEED_CAMPUS: CuratedProject[] = [
  ...
  { id: "cp_3", scope: "campus", title: "NIT Trichy Robotics Sprint", category: "Robotics", difficulty: "Advanced", seatsTotal: 8, seatsFilled: 6, timeline: "4 weeks", skills: ["ROS", "Python", "Hardware"], description: "Build a swarm of 5 autonomous bots for the national Robotics Showcase.", rewards: "Hardware kit provided · ₹12k team prize · Showcase feature", status: "live", campus: "NIT Trichy", cover: "🤖", postedBy: "Scope · NIT Trichy Chapter", postedAt: Date.now() - 86400000 * 5 },
  ...
  { id: "cp_8", scope: "campus", title: "Techno India Campus Podcast Launch", category: "Media", difficulty: "Beginner", seatsTotal: 4, seatsFilled: 1, timeline: "5 weeks", skills: ["Audio", "Interviewing"], description: "Launch Techno India's first student podcast. Interview alumni founders, monthly drops.", rewards: "Host credit · 300 XP · Audio gear stipend", status: "live", campus: "Techno India", cover: "🎙", postedBy: "Scope · Techno India Chapter", postedAt: Date.now() - 86400000 * 2 },
  ...
  { id: "cp_15", scope: "campus", title: "Kolkata Inter-Campus Hack League", category: "Engineering", difficulty: "Advanced", seatsTotal: 16, seatsFilled: 11, timeline: "8 weeks", skills: ["Operations", "Engineering"], description: "Coordinate the first inter-campus hack league across 6 Kolkata institutions. 400+ builders expected.", rewards: "League Director credit · 500 XP · ₹20k team prize pool", status: "closing-soon", campus: "Jadavpur University", cover: "🏆", postedBy: "Scope · Kolkata Zone", postedAt: Date.now() - 86400000 * 7 },
];
...
const SEED_OPEN: CuratedProject[] = [
  ...
  { id: "op_4", scope: "open", title: "National Student Design Sprint", category: "Design", difficulty: "Intermediate", seatsTotal: 60, seatsFilled: 34, timeline: "1 weekend", skills: ["Figma", "UX"], description: "48-hour national design sprint solving a real public-sector brief. Open to any campus.", rewards: "Design Fellow credit · ₹10k team prize · 350 XP", status: "live", cover: "✏️", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 3 },
  ...
  { id: "op_8", scope: "open", title: "India Campus Brand Challenge", category: "Marketing", difficulty: "Intermediate", seatsTotal: 40, seatsFilled: 22, timeline: "5 weeks", skills: ["Brand", "Strategy"], description: "Pitch a brand strategy to revive a struggling Indian D2C brand. Top 3 win mentor sessions + ₹15k.", rewards: "₹15k top prize · 300 XP · Mentor calls", status: "live", cover: "🪩", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 3 },
  ...
  { id: "op_10", scope: "open", title: "Open Pitch: AI for Public Good", category: "AI", difficulty: "Advanced", seatsTotal: 15, seatsFilled: 6, timeline: "9 weeks", skills: ["AI", "Research", "Pitch"], description: "Pitch an AI-for-public-good idea solving a real Indian problem. Top 3 get prototype funding.", rewards: "₹50k prototype fund · Mentor network · 500 XP", status: "live", cover: "🤖", postedBy: "Scope Official", postedAt: Date.now() - 86400000 * 8 },
